import { ResumeActionTypes } from "./types";
...
const defaultState = {
    Experience: [
        ...
        },
        {
            ...
            media: [
                {
                    title: "Covered Californiaâ„¢ | Official Site - Health Insurance Marketplace",
                    description:
        ...
        },
        {
            ...
            bullet_points: [
                ...
                { title: "Media API system that combined the guildâ€™s Twitter, Discord, YouTube, and Twitch content" },
